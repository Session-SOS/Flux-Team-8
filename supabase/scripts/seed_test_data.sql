...
-- Tasks
INSERT INTO tasks (id, user_id, goal_id, milestone_id, title, start_time, end_time, state, priority, trigger_type, is_recurring) VALUES
  ('d1000000-0000-0000-0000-000000000001', 'a1000000-0000-0000-0000-000000000001', 'b1000000-0000-0000-0000-000000000001', 'c1000000-0000-0000-0000-000000000002', 'Morning run — 7K', '2026-02-14 06:30:00+00', '2026-02-14 07:15:00+00', 'scheduled', 'important', 'time', true),
  ('d1000000-0000-0000-0000-000000000002', 'a1000000-0000-0000-0000-000000000001', 'b1000000-0000-0000-0000-000000000002', 'c1000000-0000-0000-0000-000000000005', 'Duolingo Spanish lesson', '2026-02-14 12:00:00+00', '2026-02-14 12:20:00+00', 'scheduled', 'standard', 'time', true),
  ('d1000000-0000-0000-0000-000000000003', 'a1000000-0000-0000-0000-000000000001', 'b1000000-0000-0000-0000-000000000001', 'c1000000-0000-0000-0000-000000000001', 'Stretch after run', '2026-02-13 07:15:00+00', '2026-02-13 07:30:00+00', 'completed', 'standard', 'time', false),
  ('d1000000-0000-0000-0000-000000000004', 'a1000000-0000-0000-0000-000000000002', 'b1000000-0000-0000-0000-000000000003', 'c1000000-0000-0000-0000-000000000007', 'Code API endpoints', '2026-02-14 10:00:00+00', '2026-02-14 12:00:00+00', 'scheduled', 'must-not-miss', 'time', false),
  ('d1000000-0000-0000-0000-000000000005', 'a1000000-0000-0000-0000-000000000002', 'b1000000-0000-0000-0000-000000000003', NULL, 'Review PR feedback', '2026-02-14 14:00:00+00', '2026-02-14 14:30:00+00', 'scheduled', 'standard', 'time', false),
  ('d1000000-0000-0000-0000-000000000006', 'a1000000-0000-0000-0000-000000000003', 'b1000000-0000-0000-0000-000000000004', 'c1000000-0000-0000-0000-000000000008', 'Read 30 pages', '2026-02-14 21:00:00+00', '2026-02-14 22:00:00+00', 'scheduled', 'standard', 'time', true),
  ('d1000000-0000-0000-0000-000000000007', 'a1000000-0000-0000-0000-000000000001', 'b1000000-0000-0000-0000-000000000001', 'c1000000-0000-0000-0000-000000000002', 'Pack gym bag before leaving', NULL, NULL, 'drifted', 'important', 'on_leaving_home', false);
